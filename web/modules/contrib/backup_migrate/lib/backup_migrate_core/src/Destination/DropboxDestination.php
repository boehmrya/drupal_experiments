...
class DropboxDestination extends DestinationBase implements
  ...
  public function fileUpload($file, $path) {
    ...
    $php_memory_limit = intval($this->byteSize(ini_get('memory_limit')) * 0.9);

    // Dropbox currently has a 150M upload limit per transaction.
    $dropbox_upload_limit = $this->byteSize('150M');
    ...
    $manual_upload_limit = $this->byteSize('150M');
   ...
   *   The size in byte.
   */
  public function byteSize($byteString) {
